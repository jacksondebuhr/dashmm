...
HelmholtzTable::HelmholtzTable(int n_digits, double size, double omega) {
  ...
  int evan_table[] = {0, 0, 0, 9, 0, 0, 18, 0, 0, 0, 0, 0, 0, 0, 0};
  int prop_table[] = {0, 0, 0, 10, 0, 0, 16, 0, 0, 0, 0, 0, 0, 0, 0};
  ...
  case 6:
	  x_e_[0] = 0.52788527661177607475107009804560221e-01;
	  x_e_[1] = 0.26949859838931256028615734976483509e+00;
	  x_e_[2] = 0.63220353174689392083962502510985360e+00;
	  x_e_[3] = 0.11130756427760852833586113774799742e+01;
	  x_e_[4] = 0.16893949614021379623807206371566281e+01;
	  x_e_[5] = 0.23437620046953044905535534780938178e+01;
	  x_e_[6] = 0.30626998290780611533534738555317745e+01;
	  x_e_[7] = 0.38356294126529686394633245072327554e+01;
	  x_e_[8] = 0.46542473432156272750148673367220908e+01;
	  x_e_[9] = 0.55120938659358147404532246582675725e+01;
	  x_e_[10] = 0.64042126837727888499784967279992998e+01;
	  x_e_[11] = 0.73268800190617540124549122992902994e+01;
	  x_e_[12] = 0.82774009925823861522076185792684555e+01;
	  x_e_[13] = 0.92539718060248947750778825138695538e+01;
	  x_e_[14] = 0.10255602723746401139237605093512684e+02;
	  x_e_[15] = 0.11282088297877740146191172243561596e+02;
	  x_e_[16] = 0.12334067909676926788620221486780792e+02;
	  x_e_[17] = 0.13414920240172401477707353478763252e+02;

	  w_e_[0] = 0.13438265914335215112096477696468355e+00;
	  w_e_[1] = 0.29457752727395436487256574764614925e+00;
	  w_e_[2] = 0.42607819361148618897416895379137713e+00;
	  w_e_[3] = 0.53189220776549905878027857397682965e+00;
	  w_e_[4] = 0.61787306245538586857435348065337166e+00;
	  w_e_[5] = 0.68863156078905074508611505734734237e+00;
	  w_e_[6] = 0.74749099381426187260757387775811367e+00;
	  w_e_[7] = 0.79699192718599998208617307682288811e+00;
	  w_e_[8] = 0.83917454386997591964103548889397644e+00;
	  w_e_[9] = 0.87570092283745315508980411323136650e+00;
	  w_e_[10] = 0.90792943590067498593754180546966381e+00;
	  w_e_[11] = 0.93698393742461816291466902839601971e+00;
	  w_e_[12] = 0.96382546688788062194674921556725167e+00;
	  w_e_[13] = 0.98932985769673820186653756536543369e+00;
	  w_e_[14] = 0.10143828459791703888726033255807124e+01;
	  w_e_[15] = 0.10400365437416452252250564924906939e+01;
	  w_e_[16] = 0.10681548926956736522697610780596733e+01;
	  w_e_[17] = 0.11090758097553685690428437737864442e+01;
...
void update_helmholtz_table(int n_digits, double size, double omega) {
  ...
  } else if (builtin_helmholtz_table_->update(n_digits, size, omega)) {
    // Replace the existing one with the updated one
    builtin_helmholtz_table_.reset(new HelmholtzTable{n_digits, size, omega});
  }
}
